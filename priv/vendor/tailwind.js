var htmx = (function () {
  ...
  function $e(h, d, p, g) {
    ...
    let e = function () {
      ...
      if (t.elt && !se(t.elt) && ee(t.elt, "id")) {
        ...
        const a = { preventScroll: p.focusScroll !== undefined ? !p.focusScroll : !Q.config.defaultFocusScroll };
        if (f) {
  ...
  function ht(e, t) {
    if (e.type === "submit" || e.type === "click") {
      ...
      t = t.closest("a");
      if (t && t.href && (t.getAttribute("href") === "#" || t.getAttribute("href").indexOf("#") !== 0)) {
        return true;
      }
    }
    return false;
  ...
  function Qt(e) {
    ...
    t.onload = function () {
      if (this.status >= 200 && this.status < 400) {
        ...
        _t(r.path);
        ae(te().body, "htmx:historyRestore", { path: e, cacheMiss: true, serverResponse: r.response });
      } else {
  ...
  function he(t, n, r, o, i, k) {
    ...
    if (k === undefined) {
      ...
      const G = { target: c, elt: r, path: n, verb: t, triggeringEvent: o, etc: i, issueRequest: K, question: a };
    ...
    ie(["loadstart", "loadend", "progress", "abort"], function (t) {
      ie([g, g.upload], function (e) {
        e.addEventListener(t, function (e) {
          ae(r, "htmx:xhr:" + t, { lengthComputable: e.lengthComputable, loaded: e.loaded, total: e.total });
        });
      });
    });
  ...
  function jn(t, e) {
    ...
    var g = n.response;
    var m = le({ shouldSwap: f, serverResponse: g, isError: a, ignoreTitle: h, selectOverride: d, swapOverride: p }, e);
    ...
    if (a) {
      fe(
        t,
        "htmx:responseError",
        le({ error: "Response Status Error Code " + n.status + " from " + e.pathInfo.requestPath }, e),
      );
    }
  }
  const Vn = {};
