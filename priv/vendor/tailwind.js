...
(() => {
      ...
      switch (l) {
        ...
        case 9: {
          ...
          for (
            ...
            l < e.length &&
            ((t = e.charCodeAt(l)),
            58 === t || 44 === t || 61 === t || 62 === t || 60 === t || 10 === t || 47 === t || 32 === t || 9 === t);
            l++
          );
          a = l - 1;
          let s = p(e.slice(n, l));
    ...
    return (
      ...
      (e = (function (e) {
        ...
        for (let i = 0; i < e.length; i++) {
          ...
          if (
            ((a >= 48 && a <= 57) || (null !== n && (37 === a || (a >= 97 && a <= 122) || (a >= 65 && a <= 90)))
              ? (n = i)
              : ((o = n), (n = null)),
            40 !== a)
          )
  ...
  function je(e, t) {
    return L(e, ",")
      .map((e) => {
        ...
        for (let e of r)
          ze.has(e) ||
            (Ce.test(e) ? (null === o ? (o = e) : null === i && (i = e), (Ce.lastIndex = 0)) : null === n && (n = e));
      ...
      set(e, { kind: t, applyFn: r, compounds: n, compoundsWith: o, order: i }) {
        ...
        a
          ...
          : (void 0 === i && ((this.lastOrder = this.nextOrder()), (i = this.lastOrder)),
            this.variants.set(e, { kind: t, applyFn: r, order: i, compoundsWith: o, compounds: n }));
      }
      nextOrder() {
    ...
    let t = (function (e) {
        ...
        function a(n, i, a, { supportsNegative: l = !1, supportsFractions: s = !1 } = {}) {
          (l && t.static(`-${n}-px`, () => a("-1px")),
            ...
            r(n, () => [
              { values: e.get(["--spacing"]) ? Ke : [], supportsNegative: l, supportsFractions: s, valueThemeKeys: i },
            ]));
        }
        (n("sr-only", [
          ["position", "absolute"],
        ...
        for (let [e, t] of [
          ...
          (n(`${e}-auto`, [[t, "auto"]]),
            n(`${e}-full`, [[t, "100%"]]),
            n(`-${e}-full`, [[t, "-100%"]]),
            a(e, ["--inset", "--spacing"], (e) => [x(t, e)], { supportsNegative: !0, supportsFractions: !0 }));
        ...
        for (let [e, t] of [
          ...
          (n(`${e}-auto`, [[t, "auto"]]), a(e, ["--margin", "--spacing"], (e) => [x(t, e)], { supportsNegative: !0 }));
        ...
        (a("border-spacing", ["--border-spacing", "--spacing"], (e) => [
          ...
          o("origin", { themeKeys: ["--transform-origin"], handle: (e) => [x("transform-origin", e)] }),
          ...
          o("perspective-origin", { themeKeys: ["--perspective-origin"], handle: (e) => [x("perspective-origin", e)] }),
        ...
        for (let e of ["x", "y"])
          (n(`-translate-${e}-full`, [
            ...
            a(
              `translate-${e}`,
              ["--translate", "--spacing"],
              (t) => [s(), x(`--tw-translate-${e}`, t), x("translate", "var(--tw-translate-x) var(--tw-translate-y)")],
              { supportsNegative: !0, supportsFractions: !0 },
            ));
        (a(
          "translate-z",
        ...
        for (let e of ["x", "y", "z"])
          (o(`scale-${e}`, {
            ...
            handle: (t) => [
              c(),
              x(`--tw-scale-${e}`, t),
              x("scale", "var(--tw-scale-x) var(--tw-scale-y)" + ("z" === e ? " var(--tw-scale-z)" : "")),
            ],
          }),
            r(`scale-${e}`, () => [
              {
        ...
        function d({ negative: t }) {
          return (r) => {
            ...
            if ("arbitrary" === r.value.kind) {
              ...
              ((n = e.resolve(r.value.value, ["--rotate"])), !n && be(r.value.value) && (n = `${r.value.value}deg`), !n)
            )
              return;
          ...
          ]));
        {
          let e = [
            ...
            i = () =>
              z([Ve("--tw-rotate-x"), Ve("--tw-rotate-y"), Ve("--tw-rotate-z"), Ve("--tw-skew-x"), Ve("--tw-skew-y")]);
          for (let t of ["x", "y", "z"])
            (o(`rotate-${t}`, {
              supportsNegative: !0,
              themeKeys: ["--rotate"],
        ...
        (n("list-inside", [["list-style-position", "inside"]]),
          ...
          o("list-image", { themeKeys: ["--list-style-image"], handle: (e) => [x("list-style-image", e)] }),
        ...
        (n("grid-flow-row", [["grid-auto-flow", "row"]]),
          ...
          o("auto-cols", { themeKeys: ["--grid-auto-columns"], handle: (e) => [x("grid-auto-columns", e)] }),
          ...
          o("auto-rows", { themeKeys: ["--grid-auto-rows"], handle: (e) => [x("grid-auto-rows", e)] }),
          ...
          n("space-x-reverse", [
            () => z([Ve("--tw-space-x-reverse", "0")]),
            () => k(":where(& > :not(:last-child))", [x("--tw-sort", "row-gap"), x("--tw-space-x-reverse", "1")]),
          ]),
          n("space-y-reverse", [
            () => z([Ve("--tw-space-y-reverse", "0")]),
            () => k(":where(& > :not(:last-child))", [x("--tw-sort", "column-gap"), x("--tw-space-y-reverse", "1")]),
          ]),
          n("accent-auto", [["accent-color", "auto"]]),
          i("accent", { themeKeys: ["--accent-color", "--color"], handle: (e) => [x("accent-color", e)] }),
          i("caret", { themeKeys: ["--caret-color", "--color"], handle: (e) => [x("caret-color", e)] }),
          i("divide", {
        ...
        (o("mask-linear", {
          ...
          handle: (e) => [
            ...
            x("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"),
            x("mask-composite", "intersect"),
            x("--tw-mask-linear", "linear-gradient(var(--tw-mask-linear-stops, var(--tw-mask-linear-position)))"),
        ...
        (n("mask-circle", [["--tw-mask-radial-shape", "circle"]]),
          ...
          o("mask-radial", {
            ...
            handle: (e) => [
              ...
              x("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"),
              x("mask-composite", "intersect"),
              x("--tw-mask-radial", "radial-gradient(var(--tw-mask-radial-stops, var(--tw-mask-radial-size)))"),
        ...
        (o("mask-conic", {
          ...
          handle: (e) => [
            ...
            x("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"),
            x("mask-composite", "intersect"),
            x("--tw-mask-conic", "conic-gradient(var(--tw-mask-conic-stops, var(--tw-mask-conic-position)))"),
        ...
        (n("mix-blend-plus-darker", [["mix-blend-mode", "plus-darker"]]),
          ...
          o("object", { themeKeys: ["--object-position"], handle: (e) => [x("object-position", e)] }));
        for (let [e, t] of [
          ["p", "padding"],
          ["px", "padding-inline"],
          ["py", "padding-block"],
        ...
        (n("text-left", [["text-align", "left"]]),
          ...
          a("indent", ["--text-indent", "--spacing"], (e) => [x("text-indent", e)], { supportsNegative: !0 }),
          ...
          o("animate", { themeKeys: ["--animate"], handle: (e) => [x("animation", e)] }));
        {
          ...
          (t.functional("filter", (e) => {
            ...
            o("blur", { themeKeys: ["--blur"], handle: (e) => [l(), x("--tw-blur", `blur(${e})`), x("filter", i)] }),
            ...
            t.functional("drop-shadow", (t) => {
              ...
              if (
                ...
                return null === t || null === n
                  ...
                  : [
                      ...
                      ...Be("--tw-drop-shadow-size", t, r, (e) => `var(--tw-drop-shadow-color, ${e})`),
                      x(
                        "--tw-drop-shadow",
                        L(n, ",")
                          .map((e) => `drop-shadow(${e})`)
                ...
                return "color" === (t.value.dataType ?? ie(n, ["color"]))
                  ...
                  : t.modifier && !r
                    ...
                    : [
                        l(),
                        x("--tw-drop-shadow-alpha", r),
                        ...Be("--tw-drop-shadow-size", n, r, (e) => `var(--tw-drop-shadow-color, ${e})`),
                        x("--tw-drop-shadow", "var(--tw-drop-shadow-size)"),
                        x("filter", i),
                      ];
              }
              ...
              }
              {
                ...
                if (r)
                  return "inherit" === r
                    ? [l(), x("--tw-drop-shadow-color", "inherit"), x("--tw-drop-shadow", "var(--tw-drop-shadow-size)")]
                    : [
                        l(),
        ...
        }
        {
          ...
          (t.static("outline-hidden", () => [
            ...
            b("@media", "(forced-colors: active)", [x("outline", "2px solid transparent"), x("outline-offset", "2px")]),
          ]),
            n("outline-none", [
              ...
              }
              {
                ...
                if (r) {
                  ...
                  return "string" == typeof o
                    ...
                    : [
                        x("font-size", n),
                        x("line-height", o["--line-height"] ? `var(--tw-leading, ${o["--line-height"]})` : void 0),
                        x(
                          "letter-spacing",
                          o["--letter-spacing"] ? `var(--tw-tracking, ${o["--letter-spacing"]})` : void 0,
                        ),
                        x("font-weight", o["--font-weight"] ? `var(--tw-font-weight, ${o["--font-weight"]})` : void 0),
                      ];
                }
              }
            }
        ...
        (n("text-shadow-initial", [T, ["--tw-text-shadow-color", "initial"]]),
          t.functional("text-shadow", (t) => {
            ...
            if ("arbitrary" === t.value.kind) {
              ...
              return "color" === (t.value.dataType ?? ie(n, ["color"]))
                ? ((n = Fe(n, t.modifier, e)),
                  null === n ? void 0 : [T(), x("--tw-text-shadow-color", Ne(n, "var(--tw-text-shadow-alpha)"))])
                : [
                    T(),
                    x("--tw-text-shadow-alpha", r),
          ...
          (n("shadow-initial", [s, ["--tw-shadow-color", "initial"]]),
            t.functional("shadow", (t) => {
              ...
              if ("arbitrary" === t.value.kind) {
                ...
                return "color" === (t.value.dataType ?? ie(n, ["color"]))
                  ? ((n = Fe(n, t.modifier, e)),
                    null === n ? void 0 : [s(), x("--tw-shadow-color", Ne(n, "var(--tw-shadow-alpha)"))])
                  : [
                      s(),
                      x("--tw-shadow-alpha", r),
            ...
            t.functional("inset-shadow", (t) => {
              ...
              if ("arbitrary" === t.value.kind) {
                ...
                return "color" === (t.value.dataType ?? ie(n, ["color"]))
                  ? ((n = Fe(n, t.modifier, e)),
                    null === n ? void 0 : [s(), x("--tw-inset-shadow-color", Ne(n, "var(--tw-inset-shadow-alpha)"))])
                  : [
                      s(),
                      x("--tw-inset-shadow-alpha", r),
                      ...Me("--tw-inset-shadow", n, r, (e) => `var(--tw-inset-shadow-color, ${e})`, "inset "),
                      x("box-shadow", a),
                    ];
              }
              switch (t.value.value) {
            ...
            t.functional("inset-ring", (t) => {
              ...
              if ("arbitrary" === t.value.kind) {
                ...
                return "length" === (t.value.dataType ?? ie(r, ["color", "length"]))
                  ...
                  : ((r = Fe(r, t.modifier, e)), null === r ? void 0 : [x("--tw-inset-ring-color", r)]);
              }
              {
                let r = We(t, e, ["--ring-color", "--color"]);
            ...
            if (t.value) {
              if ("arbitrary" === t.value.kind) {
                ...
                return "length" === (t.value.dataType ?? ie(r, ["color", "length"]))
                  ...
                  : ((r = Fe(r, t.modifier, e)), null === r ? void 0 : [x("--tw-ring-offset-color", r)]);
              }
              {
                ...
                if (be(t.value.value))
                  return t.modifier
                    ? void 0
                    : [x("--tw-ring-offset-width", `${t.value.value}px`), x("--tw-ring-offset-shadow", u)];
              }
              {
      ...
      r = (function (e) {
          ...
          r("details-content", ["&::details-content"]));
        {
          let e = function () {
            return z([
              b("@property", "--tw-content", [x("syntax", '"*"'), x("initial-value", '""'), x("inherits", "false")]),
            ]);
          };
          (t.static(
            "before",
              ...
              () => {
                t.functional(
                  ...
                  (e, t) => {
                    ...
                    if (null === r) return null;
                    e.nodes = [
                      b("@container", t.modifier ? `${t.modifier.value} (width < ${r})` : `(width < ${r})`, e.nodes),
                    ];
                  },
                  { compounds: 1 },
                );
      ...
      o = new u((e) =>
        Array.from(
          (function* (e, t) {
            ...
            let i = !1;
            ("!" === n[n.length - 1] ? ((i = !0), (n = n.slice(0, -1))) : "!" === n[0] && ((i = !0), (n = n.slice(1))),
      ...
      s = {
        ...
        getVariantOrder() {
          ...
          let t,
            ...
            o = 0;
          for (let n of e)
            null !== n && (void 0 !== t && 0 !== this.variants.compare(t, n) && o++, r.set(n, o), (t = n));
          return r;
        },
  ...
  function it(e) {
    for (let t of e)
      "at-root" !== t.kind &&
        ("declaration" === t.kind ? (t.important = !0) : ("rule" === t.kind || "at-rule" === t.kind) && it(t.nodes));
  }
  function at(e) {
    let t = new Set(),
      r = 0,
  ...
  function pt(e) {
    ...
    return e
      ...
      .map((e) => e.replaceAll(".", "_").replace(/([a-z])([A-Z])/g, (e, t, r) => `${t}-${r.toLowerCase()}`))
    ...
    let i = {
      ...
      matchUtilities(t, r) {
        ...
        for (let [i, a] of Object.entries(t)) {
          let t = function ({ negative: t }) {
            return (l) => {
              if (
                ...
                o.length > 0 &&
                !o.includes("any") &&
                ((l.value.dataType && !o.includes(l.value.dataType)) || (!l.value.dataType && !ie(l.value.value, o)))
              )
                return;
              let s,
                c = o.includes("color"),
          ...
          (r?.supportsNegativeValues && e.utilities.functional(`-${i}`, t({ negative: !0 }), { types: o }),
  ...
  function Et(e) {
    ...
    for (let [e, n] of r)
      if ("object" != typeof n) {
        ...
        t.push(x(e, String(n)));
      } else if (Array.isArray(n)) for (let r of n) "string" == typeof r ? t.push(x(e, r)) : t.push(y(e, Et(r)));
  ...
  function Yt(e, { config: t, base: r, path: n, reference: o }) {
    ...
    for (let t of i)
      (e.plugins.push(t), t.config && Yt(e, { path: n, base: r, config: t.config, reference: !!t.reference }));
    let a = t.content ?? [],
  ...
  async function er({ designSystem: e, base: t, ast: r, loadModule: n, sources: o }) {
    ...
    (C(r, (e, { parent: t, replaceWith: r, context: n }) => {
      if ("at-rule" === e.kind) {
        if ("@plugin" === e.name) {
          ...
          return (
            a.push([{ id: o, base: n.base, reference: !!n.reference }, Object.keys(l).length > 0 ? l : null]),
            r([]),
            void (i |= 4)
          );
        }
        if ("@config" === e.name) {
          ...
          return (l.push({ id: e.params.slice(1, -1), base: n.base, reference: !!n.reference }), r([]), void (i |= 4));
        }
      }
    }),
      (function (e) {
    ...
    if (
      ((e.resolveThemeValue = function (n, a) {
        return n.startsWith("--")
          ? s(n, a)
          : ((i |= tr({ designSystem: e, base: t, ast: r, sources: o, configs: [], pluginDetails: [] })),
      ...
      l = [
        ...i.map((e) => {
          ...
          if ("__isOptionsFunction" in e.plugin)
            return { config: { plugins: [e.plugin(e.options)] }, base: e.base, reference: e.reference };
              ...
              ? (r) => {
                  ...
                  (C(e.nodes, (e) => {
                    ...
                    r.utilities.suggest(t.slice(0, -2), () => {
                      let e = [],
                        t = [];
                      for (let [o, { literals: i, usedSpacingNumber: a, usedSpacingInteger: l, themeKeys: s }] of [
                        [e, n["--value"]],
                        [t, n["--modifier"]],
                      ]) {
          ...
          await (async function (e) {
            ...
            (wr.end("Collect classes", { count: t.size }),
              (0 !== t.size || "incremental" !== e) &&
                (wr.start("Build utilities"), (mr.textContent = dr.build(Array.from(t))), wr.end("Build utilities")));
          })(e),
          wr.end("Build"),
          wr.end(`Build #${t} (${e})`));
      })
  ...
  (new MutationObserver((e) => {
    ...
    for (let n of e) {
      for (let e of n.addedNodes)
        e.nodeType === Node.ELEMENT_NODE && "STYLE" === e.tagName && e.getAttribute("type") === fr && ($r(e), t++);
